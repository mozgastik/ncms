...
If your application still uses EasyAdmin 2 or 3, you must first upgrade to
EasyAdmin 4 before upgrading to EasyAdmin 5. Read the
`upgrade guide of EasyAdmin 4 <https://symfony.com/bundles/EasyAdminBundle/4.x/upgrade.html>`_
